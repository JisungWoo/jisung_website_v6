...
export const koSite = {
  ...
  description:
    "엔터프라이즈 데이터 플랫폼, AI 워크플로 제품, 실무형 실행 경험을 한곳에 정리한 Jisung Woo의 포트폴리오입니다.",
  localeSwitch: { label: "English", text: "English", href: "index.html" },
  nav: [
  ...
  hero: {
    ...
    name: "Jisung Woo",
    thesis: "복잡한 데이터 작업을 운영 가능하고, 설명 가능하며, 책임질 수 있는 시스템으로 만듭니다.",
    summary:
    ...
    tracks: [
      {
        ...
        profile: {
          ...
          proof: [
            { label: "현재 담당", value: "Snowflake EDW" },
  ...
  work: {
    ...
    body: "인프라, 인터페이스, 실행 방식이 어떻게 맞물리는지 보여 줄 수 있는 대표 작업들만 골랐습니다.",
    primaryProjects: [
      {
        id: "melodymap",
        tone: "signal",
  ...
  capabilities: {
    ...
    groups: [
      ...
      {
        title: "실행 리더십",
        items: ["분산 팀 조율", "기술 문서화", "릴리스 준비", "React 프로토타입", "창업자 사용자 탐색", "영어 (원어민)", "한국어 (원어민)"],
      },
    ],
  },
  journey: {
